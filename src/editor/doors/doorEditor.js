...
const DOOR_TYPES = [{
		...
		label: 'Horizontal Door',
		description: 'Standard left/right door'
	},
	{
		value: 'VerticalDoor',
		label: 'Vertical Door',
		description: 'Standard up/down door'
	},
	{
		value: 'HorizontalMorphTunnel',
		label: 'Horizontal Morph Tunnel',
		description: 'Morph ball passage'
	},
	{
		value: 'VerticalSandpit',
		label: 'Vertical Sandpit',
		description: 'Vertical morph ball passage'
	},
	{
		value: 'Elevator',
		label: 'Elevator',
		description: 'Area transition elevator'
	},
	{
		value: 'StoryMarker',
		label: 'Story Marker',
		description: 'Cutscene or story trigger'
	}
];
const DIRECTION_TYPES = [{
		value: 'Bi-Directional',
		label: 'Bi-Directional',
		description: 'Can traverse both ways'
	},
	{
		value: 'Forward',
		label: 'Forward Only',
		description: 'One-way passage'
	}
];
// ---- Initialization --------------------------------
