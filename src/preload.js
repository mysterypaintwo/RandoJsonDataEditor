...
contextBridge.exposeInMainWorld('api', {
    ...
    openRoomPropertiesEditor: (roomData, enemyList, itemList, eventList, weaponList, techMap, helperMap) => {
        ipcRenderer.send('open-room-properties-editor', roomData, enemyList, itemList, eventList, weaponList, techMap, helperMap);
    },
